...
function designo_theme_scripts() {
	...
	// js
	wp_enqueue_script( 'designo-theme-js', get_template_directory_uri() . '/assets/js/script.js', array(), filemtime(get_template_directory() . '/assets/js/script.js'), array('strategy'  => 'defer', 'in_footer' => false,));
